...
class Staking(IconScoreBase):
    ...
    @eventlog(indexed=3)
    def Test_eventlog_2(self, param1: int, param2: str, param3: Address, param4: bool, param5: int):
        pass
    
    @external
    def test_eventlog(self, param1: int, param2: str, param3: Address, param4: bool, param5: int, param5: str, param7: str, param8: str, param9: str):
